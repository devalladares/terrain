...
const SKETCHES = [
    ...
    { name: 'sketch8', label: 'Sketch 8 Drag, Rotate, Scroll', group: 'Floating RNA+Contours' },
    { name: 'sketch9', label: 'Sketch 9 Drag, Rotate, Scroll', group: 'Floating RNA+Contours' },
    { name: 'sketch10', label: 'Sketch 10 Drag, Rotate, Scroll', group: 'Floating RNA+Contours' },
    { name: 'sketch11', label: 'Sketch 11',group: 'Floating RNA+Contours' },
    { name: 'sketch12', label: 'Sketch 12', group: 'Floating RNA+Contours' },
    { name: 'sketch12.1', label: 'Sketch 12.1', group: 'Floating RNA+Contours' },
    // { name: 'sketch12.2', label: 'Sketch 12.2', group: 'Group' },
    // { name: 'sketch12.3', label: 'Sketch 12.3', group: 'Group' },
    { name: 'sketch5', label: 'Sketch 5 Tracing Contours', group: 'Contour+RNA' },
    { name: 'sketch5.1', label: 'Sketch 5.1', group: 'Contour+RNA' },
    { name: 'sketch5.2', label: 'Sketch 5.2', group: 'Contour+RNA' },
    { name: 'sketch5.3', label: 'Sketch 5.3', group: 'Contour+RNA' },
    { name: 'sketch5.4', label: 'Sketch 5.4', group: 'Contour+RNA' },
    { name: 'sketch5.45', label: 'Sketch 5.45', group: 'Contour+RNA' },
    { name: 'sketch5.5', label: 'Sketch 5.5 Contour+RNA Particles', group: 'Contour+RNA' },
     { name: 'sketch5.6', label: 'Sketch 5.6 Tracing Lines', group: 'Contour+RNA' },
    // { name: 'sketch5.7', label: 'Sketch 5.7', group: 'Contour+RNA' },
    // { name: 'sketch5.8', label: 'Sketch 5.8', group: 'Contour+RNA' },
    // { name: 'sketch5.45', label: 'Sketch 5.45', group: 'Contour+RNA+UpwardGraph' },
    { name: 'sketch5.46', label: 'Sketch 5.46', group: 'Contour+RNA+UpwardGraph' },
    { name: 'sketch5.47', label: 'Sketch 5.47', group: 'Contour+RNA+UpwardGraph' },
    { name: 'sketch5.48', label: 'Sketch 5.48 Drawing Image Colors', group: 'Contour+RNA+UpwardGraph' },
    { name: 'sketch5.49', label: 'Sketch 5.49', group: 'Contour+RNA+UpwardGraph' },
    { name: 'sketch5.51', label: 'Sketch 5.51', group: 'Contour+RNA+UpwardGraph' },
    { name: 'sketch5.52', label: 'Sketch 5.52', group: 'Contour+RNA+UpwardGraph' },
    { name: 'sketch5.61', label: 'Sketch 5.61 Moving Lines', group: 'Contour+RNA+UpwardGraph' },
    { name: 'sketch5.62', label: 'Sketch 5.62 GLITCH', group: 'Contour+RNA+UpwardGraph' },
    { name: 'sketch5.63', label: 'Sketch 5.63', group: 'Contour+RNA+UpwardGraph' },
    { name: 'sketch5.64', label: 'Sketch 5.64 Resembling Stars!', group: 'Exploration' },
    { name: 'sketch5.65', label: 'Sketch 5.65 RNA Moving through Possibility', group: 'Exploration' },
    { name: 'sketch5.66', label: 'Sketch 5.66', group: 'Exploration' },
    { name: 'sketch13', label: 'Sketch 13', group: 'Waves / Terrain / Possibility' },
    { name: 'sketch14', label: 'Sketch 14', group: 'Waves / Terrain / Possibility' },
    { name: 'sketch15', label: 'Sketch 15', group: 'Waves / Terrain / Possibility' },
    { name: 'sketch16', label: 'Sketch 16', group: 'Waves / Terrain / Possibility' },
    { name: 'sketch17', label: 'Sketch 17', group: 'Waves / Terrain / Possibility' },
    { name: 'sketch18', label: 'Sketch 18', group: 'Waves / Terrain / Possibility' },
    { name: 'sketch19', label: 'Sketch 19', group: 'Waves / Terrain / Possibility' },
    { name: 'sketch20', label: 'Sketch 20', group: 'Waves / Terrain / Possibility' },
    { name: 'sketch21', label: 'Sketch 21', group: 'Waves / Terrain / Possibility' },
    { name: 'sketch22', label: 'Sketch 22', group: 'Waves / Terrain / Possibility' },
    // { name: 'sketch23', label: 'Sketch 23', group: 'Waves / Terrain / Possibility' },
];
