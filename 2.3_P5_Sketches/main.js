...
const SKETCHES = [
    ...
    // { name: 'sketch5.45', label: 'Sketch 5.45', group: 'B. Contour+RNA+UpwardGraph' },
    { name: 'sketch5.46', label: 'Sketch 5.46', group: 'B. Contour+RNA+UpwardGraph' },
    { name: 'sketch5.47', label: 'Sketch 5.47', group: 'B. Contour+RNA+UpwardGraph' },
    { name: 'sketch5.48', label: 'Sketch 5.48 Drawing Image Colors', group: 'B. Contour+RNA+UpwardGraph' },
    { name: 'sketch5.49', label: 'Sketch 5.49', group: 'B. Contour+RNA+UpwardGraph' },
    { name: 'sketch5.51', label: 'Sketch 5.51', group: 'B. Contour+RNA+UpwardGraph' },
    { name: 'sketch5.52', label: 'Sketch 5.52', group: 'B. Contour+RNA+UpwardGraph' },
    { name: 'sketch5.61', label: 'Sketch 5.61 Moving Lines', group: 'B. Contour+RNA+UpwardGraph' },
    { name: 'sketch5.62', label: 'Sketch 5.62 GLITCH', group: 'B. Contour+RNA+UpwardGraph' },
    { name: 'sketch5.63', label: 'Sketch 5.63', group: 'B. Contour+RNA+UpwardGraph' },
    { name: 'sketch5.64', label: 'Sketch 5.64 Resembling Stars!', group: 'C. Exploration' },
    { name: 'sketch5.65', label: 'Sketch 5.65 RNA Moving through Possibility', group: 'C. Exploration' },
    { name: 'sketch5.66', label: 'Sketch 5.66', group: 'C. Exploration' },
    { name: 'sketch13', label: 'Sketch 13', group: 'D. Waves / Terrain / Possibility' },
    { name: 'sketch14', label: 'Sketch 14', group: 'D. Waves / Terrain / Possibility' },
    { name: 'sketch15', label: 'Sketch 15', group: 'D. Waves / Terrain / Possibility' },
    { name: 'sketch16', label: 'Sketch 16', group: 'D. Waves / Terrain / Possibility' },
    { name: 'sketch17', label: 'Sketch 17', group: 'D. Waves / Terrain / Possibility' },
    { name: 'sketch18', label: 'Sketch 18', group: 'D. Waves / Terrain / Possibility' },
    { name: 'sketch19', label: 'Sketch 19', group: 'D. Waves / Terrain / Possibility' },
    { name: 'sketch20', label: 'Sketch 20', group: 'D. Waves / Terrain / Possibility' },
    { name: 'sketch21', label: 'Sketch 21', group: 'D. Waves / Terrain / Possibility' },
    { name: 'sketch22', label: 'Sketch 22', group: 'D. Waves / Terrain / Possibility' },
    // { name: 'sketch23', label: 'Sketch 23', group: 'D. Waves / Terrain / Possibility' },
];
