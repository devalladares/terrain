...
const SKETCHES = [
    ...
    // { name: 'sketch10.9', label: 'Line+Circle',group: 'Line+Circle' },
    { name: 'sketch11.45', label: '4.5 Updated',group: 'New' },
    { name: 'sketch11.6', label: 'Square',group: 'New' },
    { name: 'sketch11.65', label: 'Square',group: 'New' },
    { name: 'sketch11.8', label: 'Line+Circle',group: 'New' },
    { name: 'sketch11.85', label: 'Line+Circle',group: 'New' },
];
