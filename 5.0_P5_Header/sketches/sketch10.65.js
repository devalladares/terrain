export default function(p) {
  const CONFIG = {
    ...
    CURRENT_TRAIL_STYLE: 'squares',  // Starting trail style
    STROKE_WEIGHT: 0.2,           // General stroke weight for trails
    PLUS_STROKE_WEIGHT: 0.5,      // Specific stroke weight for plus symbols <3
    CIRCLE_SIZE: 2,                // Size of circles in trails
    PLUS_SIZE: 5,                  // Size of plus symbols
    SQUARE_SIZE: 2,                // Size of squares in trails
    TRAIL_LENGTH: 0,
    FLOW_VECTOR_SCALE: 3,
    LINE_OPACITY: 255,
    ...
    SPEED_FACTOR_RANGE: [0.5, 1.2],
    TRAIL_LENGTH_RANGE: [500, 1500], // Adjusted for variability
    MOUSE_SPAWN_RADIUS: 40,
    CIRCLE_SPACING: 5,            // Distance between trail elements
    DASH_LENGTH: 10,
    GAP_LENGTH: 20,
