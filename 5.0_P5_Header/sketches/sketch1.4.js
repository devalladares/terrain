export default function(p) {
  const CONFIG = {
    ...
    LINE_WEIGHT: 1,                      // Reduced line weight as requested
    PARTICLE_LIFETIME: 5000,              // Much longer lifetime for longer trails
    FADE_DURATION: 5000,                   // Longer fade for smoother transition
    ...
    SPAWN_INTERVAL: 1,                  // Increased interval between spawns
    MAX_PATH_LENGTH: 4000                 // Much longer maximum path length
  };
