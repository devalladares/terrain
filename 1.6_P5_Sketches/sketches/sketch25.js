...
export default function(p) {
  ...
  let inc = 0.5;   // Noise increment (smaller => smoother, more stretched flow)
  let scl = 20;     // Size of each flow-field cell (bigger => chunkier flow cells)
  ...
  let particles = [];
  let numParticles = 800; // Fewer particles for more negative space / separation
