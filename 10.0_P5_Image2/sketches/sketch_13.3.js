...
export default function sketch13(p) {
    ...
    const gapFactor = 0.8;         // Gap between squares as a fraction of cell size

    const palette = ["#F098F4", "white","#96D39B", "#57D7F2"]; // Updated white color to full opacity

    // Noise/animation parameters
    const offset = 10;             // Noise offset
    const rad = 2;                 // Radius amplitude for noise
    ...
    p.setup = () => {
        ...
        p.strokeWeight(1);           // Stroke weight
