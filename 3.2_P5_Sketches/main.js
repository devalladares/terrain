...
const SKETCHES = [
    // You only need to specify label if it's different from the auto-generated one
     ...
     { name: 'sketch101', group: 'New' },
    { name: 'sketch102', group: 'New' },
    { name: 'sketch102.1', group: 'New' },
    { name: 'sketch102.2', group: 'New' },
    { name: 'sketch103', group: 'New' },
    { name: 'sketch103.3', group: 'New' },
    { name: 'sketch110.1', group: 'New' },
    { name: 'sketch110.2', group: 'New' },
    { name: 'sketch110.3', label:'Sketch 110.3 hover and click', group: 'New' },
    { name: 'sketch105.1', label:'Sketch 105.1 Plus+', group: 'New' },
    // { name: 'sketch106.1', label:'Sketch 105.1 Plus+', group: 'New' },
    { name: 'sketch106.4', group: 'New' },
    { name: 'sketch106.5', group: 'New' },
    { name: 'sketch106.6', group: 'New' },
    { name: 'sketch106.7', group: 'New' },
    { name: 'sketch106.9', group: 'New' },
    { name: 'sketch106.11', group: 'New' },
    { name: 'sketch106.12', group: 'New' },
    { name: 'sketch106.13', group: 'New' },
    { name: 'sketch106.14', group: 'New' },
    ////////////////////////////////////////////////////////////
