...
export default function(p) {
    ...
    const NUM_ROWS = 100;         // How many horizontal lines
    const NUM_COLS = 300;        // How many points in each line
    const WAVE_HEIGHT = 200;     // Vertical displacement amplitude of the waves
    const NOISE_SCALE = 0.02;    // Perlin noise scale factor (smaller = smoother waves)
