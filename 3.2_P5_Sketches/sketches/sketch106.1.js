export default function(p) {
    ...
    const CONFIG = {
        ...
        maxPhi: Math.PI / 2.5,
        camRadius: 900,
        peakThreshold: 100, // Height threshold for peaks
        rippleSpeed: 0.1,   // Speed of ripple effect
        rippleRadius: 5,    // How far the ripple spreads
        colors: {
    ...
    let zValues = [];
    let peakRipples = []; // Store active ripples
    let camTheta = 0;
